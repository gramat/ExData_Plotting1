...
#plot type="l" - put on plot a line for Sub_metering_1
...
lines(strptime(powerData$Time, format="%Y-%m-%d %H:%M:%S"), powerData$Sub_metering_2, col="red")
#add line for Sub_metering_3
lines(strptime(powerData$Time, format="%Y-%m-%d %H:%M:%S"), powerData$Sub_metering_3, col="blue")
#add legend
legend("topright", legend=colnames(powerData)[7:9], col=c("black", "red", "blue"), lty=1)
